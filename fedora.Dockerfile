...
RUN --mount=type=cache,target=/var/cache/dnf \
    ...
    python3-cython python3-fastjsonschema  --skip-unavailable 
...
RUN dnf install -y \
    ...
    potrace-devel harfbuzz-devel --skip-unavailable 
...
RUN dnf install -y \
    ...
    fontconfig-devel xorg-x11-server-Xorg xorg-x11-xauth --skip-unavailable 
...
RUN dnf install -y \
    ...
    vulkan-headers vulkan-loader-devel vulkan-devel --skip-unavailable 
...
RUN dnf install -y \
    ...
    pulseaudio-libs-devel  --skip-unavailable 

    # --- Utility & Helper Libraries ---

RUN dnf install -y boost-devel pugixml-devel yaml-cpp-devel pystring-devel \
